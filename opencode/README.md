...
|-----------|--------|----------------|
| `plugin/` | Contains git submodules, compiled JS, node_modules (e.g., oh-my-openagent, shell-strategy) | Plugins are declared in `opencode.jsonc` under `"plugin"` and auto-installed by opencode on first run |
